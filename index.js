...
if(cmd === `${prefix}remrole`){
  ...
  if(cmd === `config`){
    ...
    .setColor('RANDOM')
    .addField("`For set welcome, create channel:` 'welcome_leave'","*Wumpus*")
    .addField("`For set log, create channel:` 'wumpuslog'", "*Wumpus*")
    .addField("`For set report, create channel:` 'reports' ", "*Wumpus*")
    .addField("`For mute, create role:` 'muted'", "*Wumpus*")
    .addField("`For modinator log, create channel:` 'incidents'", "*Wumpus*");
...
if(cmd === `${prefix}hello`){
  ...
  if(cmd === `${prefix}kick`){
    ...
    const embed = new Discord.RichEmbed()
      ...
      msg.edit(`***User has kicked! Id: ${user.id}***`);
